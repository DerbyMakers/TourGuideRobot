...
// This example is designed for use with six QTR-^A sensors
...
// map the value to a single byte (0 to 255)
position = map(position, 0, 7000, 0, 255);
//Serial.println(); // uncomment this line if you are using raw values
//Serial.println(position); // comment this line out if you are using raw values
Serial.write(position); // use this line to send individual bytes

// light the led when turning one way, and dim it when turning the other
if (position < 128)
{
